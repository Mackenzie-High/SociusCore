...
public final class Router<K, M>
{
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> publish (final Actor<?, M> connector,
                                                      final K key)
    {
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> publish (final Actor.Output<M> connector,
                                                      final K key)
    {
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> unpublish (final Actor<?, M> connector,
                                                        final K key)
    {
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> unpublish (final Actor.Output<M> connector,
                                                        final K key)
    {
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> subscribe (final Actor<M, ?> connector,
                                                        final K key)
    {
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> subscribe (final Actor.Input<M> connector,
                                                        final K key)
    {
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> unsubscribe (final Actor<M, ?> connector,
                                                          final K key)
    {
     ...
     * {@inheritDoc}
     */
    public synchronized Router<K, M> unsubscribe (final Actor.Input<M> connector,
                                                          final K key)
    {
        subscriptions.remove(key, connector);
        return this;
    ...
    public synchronized Router<K, M> send (final K key,
                                                   final M message)
    {
