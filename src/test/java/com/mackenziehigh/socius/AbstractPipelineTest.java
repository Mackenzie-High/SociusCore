...
import com.mackenziehigh.socius.AbstractPipeline;
 ...
 * Unit Test.
 */
public final class AbstractPipelineTest
{
    private final AsyncTestTool tester = new AsyncTestTool();

    private final AbstractPipeline<Integer, String> actor = new AbstractPipeline<Integer, String>(tester.stage())
    {
        @Override
